...
public class FrameAdmin extends JFrame {
    ...
    private JLabel jl3 = new JLabel("Level/Company");
    ...
    private JComboBox<String> jcb = new JComboBox<String>(arr);           //add user.level
    private JButton btn1 = new JButton("Add User");
    private JButton btn2 = new JButton("List Users");
    ...
    public FrameAdmin(){
        ...
        jtf1.setBounds(130,30,100,30);
        jl2.setBounds(30,70,70,30);
        jtf2.setBounds(130,70,100,30);
        jl3.setBounds(30,110,140,30);
        jcb.setBounds(130,110,100,30);
    ...
    private void listener(){
        File file = new File("src/fileRepo/users.txt");
                ...
                new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        if (jtf1.getText().trim().length() == 0 || jtf2.getText().trim().length() == 0
                            ...
                            JOptionPane.showMessageDialog(null, "Username, password, or level cannot be empty!");
                        }
                ...
                new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        for (User tmp: userArrayList){
                            str = str + tmp.getUserName() + ", level " + tmp.getLevel() + System.lineSeparator();
                        }
                        jta.setText(str);
                    }
                }
                ...
                new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        if (flag) {
                            ...
                            JOptionPane.showMessageDialog(null,"This user was not found!");
                        }
                    }
                }
        );
