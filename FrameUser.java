...
public class FrameUser extends JFrame {
    ...
    private JButton btn5 = new JButton("Clear");

    private JLabel jl3 = new JLabel("Select a Model");
    private String[] arr = {"-select-","Biba", "Bell-LaPadula", "Chinese Wall"};
    private JComboBox<String> jcb = new JComboBox<String>(arr);
    ...
    private void listener() {
        btn1.addActionListener(
                new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        File file = new File("src/fileRepo/" + jtf3.getText() + ".txt");
                        if (jtf3.getText().trim().length() == 0){
                            JOptionPane.showMessageDialog(null, "File name cannot be empty!");
                        }
                        else if (jtf3.getText().indexOf(" " ) != -1){
                            JOptionPane.showMessageDialog(null, "You cannot use space as your file name!");
                        }
                        else{
                            if (file.exists()){
        ...
        btn2.addActionListener(
                new ActionListener() {
                    @Override
                    public void actionPerformed(ActionEvent e) {
                        JFileChooser jfc = new JFileChooser(new File("src/fileRepo"));  //set default directory
        ...
        btn3.addActionListener(
                new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        File file2 = new File("src/fileRepo/users.txt");
                        jta1.setText("");
